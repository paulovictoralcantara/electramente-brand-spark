...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Header */}
      <header className="w-full bg-black py-4 px-6 md:px-10">
      ...
      <main className="flex-grow">
        <section className="py-12 md:py-20 bg-gradient-to-br from-black to-zinc-900 text-white">
          <div className="container mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1 animate-fade-in">
                <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                  <span className="text-amber-400">Diagnóstico Gratuito</span> de Posicionamento Estratégico da sua Marca Pessoal
                </h1>
              ...
              <div className="order-1 md:order-2">
                <div className="bg-zinc-800/60 backdrop-blur-sm p-8 rounded-xl border border-zinc-700/50 shadow-xl animate-scale-in">
                  <h2 className="text-2xl font-bold mb-6 text-center">
                    <span className="text-amber-400">Garanta</span> seu diagnóstico gratuito
                  </h2>
        ...
        <section className="py-16 bg-zinc-100">
          <div className="container mx-auto px-6 md:px-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center">
              Por que fazer seu <span className="text-amber-500">diagnóstico estratégico</span>?
            </h2>
            
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-md hover-scale">
                <div className="bg-amber-500 rounded-full w-14 h-14 flex items-center justify-center mb-6">
        ...
        <section className="py-16 bg-gradient-to-r from-amber-500 to-amber-600 text-white">
          <div className="container mx-auto px-6 md:px-10 text-center">
            ...
            <Button 
              ...
              className="bg-black hover:bg-zinc-800 text-white px-8 py-3 text-lg font-semibold"
            >
